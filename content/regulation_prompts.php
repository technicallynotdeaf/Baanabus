...
return [
    ...
    ['id' =>  8, 'category' => 'breath',         'text' => "Physiological sigh: double inhale through your nose (sniff, then top it up), then one long slow exhale through your mouth. Do 3."],
    ['id' =>  9, 'category' => 'breath',         'text' => "Breathe in for 4 counts, out for 8. The longer exhale activates your rest system. Do it 6 times."],
    ...
    // Self-compassion
    ['id' => 20, 'category' => 'self_compassion','text' => "Put a hand on your chest. Say to yourself: this is hard right now. That's okay. I'm doing okay."],
    ['id' => 21, 'category' => 'self_compassion','text' => "Think of someone who loves you. What would they say to you right now if they could see you?"],
    ['id' => 22, 'category' => 'self_compassion','text' => "What's one small thing that's gone okay today — even something tiny?"],
